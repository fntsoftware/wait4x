...
func NewACommand() *cobra.Command {
  ...
  wait4x dns A wait4x.dev --expect-ip 172.66.159.246
  wait4x dns A wait4x.dev --expect-ip 172.66.159.246 --expect-ip 104.21.60.85

  # Check A records using a custom nameserver
  wait4x dns A wait4x.dev --expect-ip 172.66.159.246 -n gordon.ns.cloudflare.com
  ...
  wait4x dns A wait4x.dev --expect-ip 172.66.159.246 --invert-check`,
		RunE: runA,
	}
